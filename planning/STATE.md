...
**Last touched:** 2026-07-17 -- **COMPREHENSIVE SECURITY AUDIT + SEPARATE REFACTOR PLANS COMPLETE (DOCUMENTATION ONLY).** Reviewed revision `f032bbb`; no Critical/High confirmed findings; four Medium change-control/publication findings must close or be accepted before refactoring. Plans: `planning/specs/2026-07-17-comprehensive-security-audit.md`, `2026-07-17-map-refactor-plan.md`, `2026-07-17-dashboard-refactor-plan.md`, and `2026-07-17-resident-guide-refactor-plan.md`. Verified baseline: Svelte check clean; 279 Vitest, 229 pipeline/tools pytest, and 38 pin-editor pytest passed; production/PWA build passed. Prior milestone: 2026-07-16 -- **INTERNAL PREVIEW ROLLOUT BUILT** (admin greenlight; dept heads +
